            ...
            <div className="w-11/12 h-5/6 rounded-3xl p-10 ">
                <div
                    ...
                    <div className="w-full flex justify-center">
                        ...
                        <div className="proPercentage mx-3 font-bold w-14 text-center text-white">54.27%
                        </div>
                        <div className="w-1/2 h-5 rounded-lg bg-gray-300 flex">
                            <div className="proGage h-full bg-yellow-300 rounded-l-lg text-center"
                                //th:style="'width:'+${view_pro_rate}+'%'"
                                //th:classappend="${view_pro_rate == '100.0'}? 'rounded-r-lg' : ''" style="width: 54.27%;"
                                ></div>
                            <div className="conGage h-full bg-blue-400 rounded-r-lg text-center"
                                //th:style="'width:'+${view_con_rate}+'%'"
                                //th:classappend="${view_con_rate == '100.0'}? 'rounded-l-lg' : ''" style="width: 45.73%;"
                                ></div>
                        </div>
                        <div className="conPercentage mx-3 font-bold w-14 text-center text-white">45.73%
                        </div>
                    ...
                    <div className=" p-4 flex items-center">
                        <input type="text" placeholder="여러분의 의견을 말해주세요"
                            className="msgInput flex-1 border rounded-full px-4 py-2 focus:outline-none" />
